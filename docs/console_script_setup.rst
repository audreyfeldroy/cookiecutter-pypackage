...
Optionally, your package can include a console script using Typer, Click or argparse (Python 3.2+).

How It Works
------------

If the 'command_line_interface' option is set to ['typer'], ['click'] or ['argparse'] during setup, cookiecutter will
