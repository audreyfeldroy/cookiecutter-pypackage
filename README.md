...
You can override any template variable directly from the command line using
`key=value` arguments, skipping individual prompts. This is useful for
scripting or CI/CD pipelines where you already know the values you want.
...
```bash
uvx cookiecutter-pypackage project_name="My Package" github_username="janedoe"
```
